...
const TopRatedTvPage = () => {
  ...
  const introTopRatedTv = movieSlice(tvLists);
  return (
    <>
      <IntroMovies movies={introTopRatedTv} loading={loading} />
      <Box
        sx={{
      ...
      >
        <Container maxWidth="xl">
          <TypographyTitle>Phim truyền hình được đánh giá cao</TypographyTitle>
